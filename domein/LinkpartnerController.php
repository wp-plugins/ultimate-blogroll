    ...
    private function step1() {
        ...
        if(isset($_POST["wizard"])) {
            ...
            if($error->ContainsErrors() === false) {
                ...
                PersistentieMapper::Instance()->SetConfig("permalink", $the_page_id);
                 ...
                 * 
                 */
                PersistentieMapper::Instance()->SetConfig("recaptcha_public_key", @$_POST["public_key"]);
                PersistentieMapper::Instance()->SetConfig("recaptcha_private_key", @$_POST["private_key"]);
            ...
            //$t = null;
            $t = @get_the_title(PersistentieMapper::Instance()->GetConfig("permalink"));
            ...
            $gui["value"]["public_key"]     = PersistentieMapper::Instance()->GetConfig("recaptcha_public_key");
            $gui["value"]["private_key"]    = PersistentieMapper::Instance()->GetConfig("recaptcha_private_key");
        }
    }
